...
netlist = 'LRCparallel.cir';
raw_file = 'LRCparallel.csv';

%edit theoretical values of the circuit
R=1559.5;
C=5.85*10^(-9);
L=0.068*10^(-3);

%edit the SPICE netlist for simulation (edit nominal values)
R1='1.5k';
C1='5.7n';
L1='0.069m';
...
%transfer Functions for LRCP circuits
